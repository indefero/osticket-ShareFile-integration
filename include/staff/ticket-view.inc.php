            ...
            <div id="action-dropdown-more" class="action-dropdown anchor-right">
              <ul>
                ...
                <?php
                 ...
                 //if($ticket->isOpen() && ($dept && $dept->isManager($thisstaff))) {<- JEF change to enable unassign tickets for admins added line below
                 	if($ticket->isOpen() && ($dept && $thisstaff->isAdmin())) {
...
<?php } # endif (canned-resonse-enabled)
    ...
    echo $attrs; ?>><?php echo $_POST ? $info['response'] : $draft;
		...
		<!-- this is for the "Post Reply" tab, not the "Post Internal Note" tab-->
        <p  style="text-align:center;">
            <input class="save pending" type="submit" value="<?php echo __('Post Reply');?>">
            <input class="" type="reset" value="<?php echo __('Reset');?>">
			<!--new Feature =COMING SOON= -->
			<input id="SF_INTEGRATION_GEN_LINK" type="button" value="Get SF Link">
        </p>
    </form>
    <?php
    } ?>
